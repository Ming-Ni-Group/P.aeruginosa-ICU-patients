...
def main():
	...
	print("filt Homo: " + str(len(Depreli_OtherHom)))
	print("filt repeat: " + str(len(Depreli_repeat)))
	print("final Posi num: " + str(len(finalPosi)))
	print()
	print("sample SNP ")
	...
	summary.append("final SNPs posis num  :" + str(len(finalPosi)))
	summary.append('')
